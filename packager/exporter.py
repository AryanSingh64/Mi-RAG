...
# Fast check if all packages are already importable (bypasses pip install in 0.01s!)
...
# Fast check if Ollama already has the target model cached in memory/disk
...
# Step 2: Check & pull model only if missing
if not model_ready:
    ...
    print(f"[2/2] [✓] Model '{model_name}' is cached and ready!")
